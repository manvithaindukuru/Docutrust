...
raw_origins = os.getenv(
    "FRONTEND_URLS",
    "http://localhost:3000,http://localhost:5173,https://docutrust-frontend.onrender.com"
)
...
# dev shortcut (optional but helpful)
if ENV == "dev":
    origins_list = ["*"]

app.add_middleware(
    CORSMiddleware,
    allow_origins=origins_list if ENV != "dev" else ["*"],
